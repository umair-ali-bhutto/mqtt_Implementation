...
@Component("com.fuel.ws.classes.WsFuelAppAddCard")
public class WsFuelAppAddCard implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			AgLogger.logInfo("Otp: " + otpPin);
			UserLogin userModel = userLoginService.validetUserid(Integer.parseInt(rm.getUserid()));
			String responseProc = DBProceduresFuel.fuelAppProcess(rm.getCorpId(), "link_card", userModel.getUserId(),
