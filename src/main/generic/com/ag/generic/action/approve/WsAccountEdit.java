...
@Component("com.ag.generic.action.approve.WsAccountEdit")
public class WsAccountEdit implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "ACCOUNT_EDIT", "EDIT",
