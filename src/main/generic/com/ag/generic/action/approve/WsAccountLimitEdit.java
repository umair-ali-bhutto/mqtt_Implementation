...
@Component("com.ag.generic.action.approve.WsAccountLimitEdit")
public class WsAccountLimitEdit implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "ACCOUNT_LIMIT_EDIT", "EDIT",
