...
@Component("com.ag.generic.action.approve.WsCardProfileEdit")
public class WsCardProfileEdit implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "CARD_ENTRY", "EDIT",
