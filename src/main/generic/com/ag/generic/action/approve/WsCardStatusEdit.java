...
@Component("com.ag.generic.action.approve.WsCardStatusEdit")
public class WsCardStatusEdit implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "CARD_STATUS_UPDATE", "EDIT",
