...
@Component("com.ag.generic.action.approve.WsCompanyCreation")
public class WsCompanyCreation implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "ADD_COMPANY", "INSERT",
