...
@Component("com.ag.generic.action.approve.WsEditCompanyProfile")
public class WsEditCompanyProfile implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			String[] responseProc = AGFuelUtil.fuelAppProcess(rm.getCorpId(), "COMPANY_EDIT", "EDIT",
