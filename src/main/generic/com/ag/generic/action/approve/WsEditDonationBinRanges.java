...
@Component("com.ag.generic.action.approve.WsEditDonationBinRanges")
public class WsEditDonationBinRanges implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			if (recordModel != null) {
				...
				recordModel.setUpdateDate(new Timestamp(new Date().getTime()));
