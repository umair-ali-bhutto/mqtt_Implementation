...
@Component("com.ag.generic.action.approve.WsOfflineSaleMerchantDataAdd")
public class WsOfflineSaleMerchantDataAdd implements WisherForApprover {
	...
	public ResponseModel doProcess(RequestModel rm, MakerCheckerConfig mck, MakerCheckerData md) {
		...
		try {
			...
			MerConfMaster recordModel = confMasterService.fetchByMidTid(mid, tid, "OFFLINE_SALE");
