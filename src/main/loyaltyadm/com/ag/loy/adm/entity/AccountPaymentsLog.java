...
/**
 * The persistent class for the ACCOUNT_PAYMENTS_LOG database table.
 * 
 */
@Entity
@IdClass(AccountPaymentsLogId.class)
@Table(name="ACCOUNT_PAYMENTS_LOG")
@NamedQuery(name="AccountPaymentsLog.findAll", query="SELECT a FROM AccountPaymentsLog a where a.corpid=:corpid")
public class AccountPaymentsLog implements Serializable {
