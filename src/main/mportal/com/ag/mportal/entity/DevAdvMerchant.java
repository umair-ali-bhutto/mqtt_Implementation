...
@Entity
@Table(name = "DEV_ADV_MERCHANT")
@NamedQuery(name = "DevAdvMerchant.fetchAll", query = "SELECT d FROM DevAdvMerchant d WHERE d.active = 'Y' ORDER BY d.advId")
public class DevAdvMerchant implements Serializable {
