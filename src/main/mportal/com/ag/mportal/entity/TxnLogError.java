 ...
 */
@Entity
@Table(name = "TXN_LOGS_ERROR")
public class TxnLogError implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "TXN_LOGS_ERROR_SEQ")
	@SequenceGenerator(name="TXN_LOGS_ERROR_SEQ",sequenceName="TXN_LOGS_ERROR_SEQ", allocationSize=1)
	private long id;
