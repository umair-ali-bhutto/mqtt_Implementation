...
@Component("com.mportal.ws.classes.WsFetchMarketSegmentThreshold")
public class WsFetchMarketSegmentThreshold implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			List<ViewR1R2MarketSegmebtThresholdModel> lst = masterService.fetchR1R2Data(mid, tid);
