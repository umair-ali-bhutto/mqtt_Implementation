...
@Component("com.mportal.ws.classes.WsMerchantLogin")
public class WsMerchantLogin implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			if (user != null) {
				int defaultMerchantGrup = Integer.parseInt(AppProp.getProperty("defult.merchant.group"));
	...
	HashMap<Object, Object> getOthersData(UserLogin usr, String channel) {
		...
		try {
			...
			if (!channel.equalsIgnoreCase("android") && !channel.equalsIgnoreCase("ios")) {
				...
				mp.put("tapNPayEnable", AppProp.getProperty("tap.n.pay.enabled"));
				mp.put("tapNPayPinEnable", AppProp.getProperty("tap.n.pay.pin.enabled"));
