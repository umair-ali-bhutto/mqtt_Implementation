...
@Component("com.mportal.ws.classes.WsOfflineTxnSummaryReportDownload")
public class WsOfflineTxnSummaryReportDownload implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			if (!Objects.isNull(merchantId) || (!Objects.isNull(fromdate) && !Objects.isNull(todate))
				...
				List<TxnSummary> trxnModel = offlineSaleService.fetchOfflineSaleTxnSummary(midList,flightList, tid, frDate, tDate, sett, btch,
						ath);
