...
@Component("com.mportal.ws.classes.WsSettlementReport")
public class WsSettlementReport implements Wisher {
...
//						midList.add(mId);
				...
				if (!Objects.isNull(lstReportItems) && !lstReportItems.isEmpty()) {
					...
					if (flag.equals("Y")) {
						totalRecords = txnDetailsService.fetchTxnDetailsCount(midList, tid, frDate, tDate, "Y", btch,
								ath, "SETTLEMENT");
