...
@Component("com.mportal.ws.classes.WsTapNPayBatchSettlement")
public class WsTapNPayBatchSettlement implements Wisher {
	...
	public ISO8583Model doProcessBatch(TapNPayBatchConfig btc, TapNPayRoutingConfig routing, String countTxn,
		...
		try {
			...
			AgLogger.logInfo("LENGHT "+String_to_bcd.convert("00" + f63.length() + Hex.encodeHexString(f63.getBytes())));
