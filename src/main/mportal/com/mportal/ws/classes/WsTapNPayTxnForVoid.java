...
@Component("com.mportal.ws.classes.WsTapNPayTxnForVoid")
public class WsTapNPayTxnForVoid implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			List<TapNPayTransactions> lst = tapNPayTransactionService.fetchTxnByMidTidForVoid(mid,tid);
			if (lst.size()!=0) {
