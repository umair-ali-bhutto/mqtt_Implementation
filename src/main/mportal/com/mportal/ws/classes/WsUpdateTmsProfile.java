...
@Component("com.mportal.ws.classes.WsUpdateTmsProfile")
public class WsUpdateTmsProfile implements Wisher {
	...
	public ResponseModel doProcess(RequestModel rm) {
		...
		try {
			...
			tmsParametersServiceImpl.update(finProfile);
			
			response.setCode("0000");
			response.setMessage("Record Successfully Update");
