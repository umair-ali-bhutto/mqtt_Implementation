...
@Component("com.mportal.ws.classes.WsWebEcrTxnReportDownload")
public class WsWebEcrTxnReportDownload implements Wisher {
		...
		try {
			...
			if (!Objects.isNull(merchantId) || (!Objects.isNull(fromdate) && !Objects.isNull(todate))
				...
				if (trxnModel != null) {
					...
					List<ReportModel> lstReportItems = ecrLogsService.fetchWebEcrTxnReport(midList, channelList, tid,
